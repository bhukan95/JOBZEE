...
// mongodb+srv://prakashbhukan95:prakash@cluster0.fqqgq7x.mongodb.net/?retryWrites=true
     ...
     export const postApplication = catchAsyncErrors(async(req,res,next)=>{
        ...
        if(role === "Employer"){
         ...
         if(!allowedFormats.includes(resume.mimetype)){
            return next(new ErrorHandler("Invalid fiile type. Please upload your resume a PNG,JPG OR WEBP format.",400));
